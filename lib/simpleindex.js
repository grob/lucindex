...
SimpleIndex.prototype.query = function(query, limit) {
    ...
    return new Result(this.index.searcher.search(query, limit), (new Date()) - start, this.index.searcher);
};
 ...
 * @constructor
 */
var Result = function(topdocs, querytime, searcher) {
    this.size = function() {
