var {DoubleField, IntField, Field,
    LongField, StringField, TextField} = org.apache.lucene.document;
var utils = require("./utils");
var {WildcardQuery, NumericRangeQuery, TermQuery} = org.apache.lucene.search;
 ...
 */
var BaseField = exports.BasicField = function(config) {
    config = config || {};
...
exports.DefaultField = BaseField.extend({
    ...
    getQueryFor: function(val) {
        ...
        return this.queryparser.parse(val);
    }
});
...
exports.DoubleField = exports.FloatField = BaseField.extend({
    ...
    getQueryFor: function(val) {
        ...
        if (typeof(val) == "object" && val.min != undefined && val.max != undefined) {
            ...
            throw new Error("DoubleField.getQueryFor called with non-numeric value");
        }
...
exports.IntField = BaseField.extend({
    ...
    getQueryFor: function(val) {
        ...
        if (typeof(val) == "object" && val.min != undefined && val.max != undefined) {
            ...
            throw new Error("IntField.getQueryFor called with non-numeric value");
        }
...
exports.DateField = BaseField.extend({
    ...
    toLucene: function(val) {
        ...
        if (!dat) {
            throw new Error("Non-date value may not be converted by DateField" + getValueInfo(val));
        }
    ...
    encodeForQuery: function(val) {
        var dat = utils.convertToDate(val, this.resolution);
        if (!dat)
            throw new Error("Non-date value may not be encoded for query by DateField" + getValueInfo(val));
    ...
    getQueryFor: function(val) {
        ...
        if (typeof(val) == "object" && val.min != undefined
            ...
            if (min == null || max == null) {
                throw new Error("Non-date values may not be used for querying a DateField\nMin:" +
            ...
            var dat = utils.convertToDate(val, this.resolution);
            if (dat == null) {
                throw new Error("Non-date value may not be used for querying a DateField" + getValueInfo(val));
            }
