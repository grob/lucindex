...
/**
 * Converter are field-definitions holding functions which get called by
 * SimpleIndex for the different interactions with lucene.
 * Namely those are:
...
exports.TextField = BaseField.extend({
    ...
    getQueryFor: function(val) {
        return new WildcardQuery(new Term(this.name, val));
    }
});
...
/**
 * StringField the most basic converter i can think of.
 */
