...
Index.prototype.query = function(field, search, filter, limit) {
    ...
    if (Object.prototype.toString.call(field) == "[object Array]") {
        ...
        for each (var i in field) {
            q.add((new AnalyzingQueryParser(this.version, i, this.analyzer)).parse(search), BooleanClause.Occur.SHOULD);
        }
    } else {
        qp = AnalyzingQueryParser(this.version, field, this.analyzer);
