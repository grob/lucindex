...
var {Term, IndexWriter, IndexWriterConfig, DirectoryReader} = org.apache.lucene.index;
var {IndexSearcher, TopDocs, WildcardQuery} = org.apache.lucene.search;
var {StandardAnalyzer} = org.apache.lucene.analysis.standard;
var {AnalyzingQueryParser} = org.apache.lucene.queryparser.analyzing;
var {FuzzyQuery} = org.apache.lucene.search;
 ...
 */
Index.prepareFloatValue = function(val) {
 ...
 * @returns ByteRef value to use in Term or for update/remove
 */
Index.prepareIntValue = function(val) {
 ...
 * @returns ByteRef value to use in Term or for update/remove
 */
Index.prepareDoubleValue = function(val) {
    return this.prepareLongValue(NumericUtils.doubleToSortableLong(val));
};
 ...
 * @returns ByteRef value to use in Term or for update/remove
 */
Index.prepareLongValue = function(val) {
 ...
 * Those functions are:
 * Index.prepareFloatValue(val), Index.prepareIntValue(val), 
 * Index.prepareDoubleValue(val) and Index.prepareLongValue(val)
